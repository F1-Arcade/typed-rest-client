...
export class RestClient {
  ...
  public async options<T>(
    ...
    let res: httpm.HttpClientResponse = await this.client.options(
      url,
  ...
  public async get<T>(
    ...
    let url: string = util.getUrl(
      resource,
      this._baseUrl,
      (options || {}).queryParameters
    );
    let res: httpm.HttpClientResponse = await this.client.get(
      url,
      this._headersFromOptions(options)
    );
    return this.processResponse<T>(res, options);
  ...
  public async del<T>(
    ...
    let res: httpm.HttpClientResponse = await this.client.del(
      url,
      this._headersFromOptions(options)
    );
    return this.processResponse<T>(res, options);
  ...
  public async create<T>(
    ...
    let res: httpm.HttpClientResponse = await this.client.post(
      url,
      data,
      headers
    );
  ...
  public async update<T>(
    ...
    let data: string = JSON.stringify(resources, null, 2);
    let res: httpm.HttpClientResponse = await this.client.patch(
      url,
      data,
      headers
    );
  ...
  public async replace<T>(
    ...
    let data: string = JSON.stringify(resources, null, 2);
    let res: httpm.HttpClientResponse = await this.client.put(
      url,
      data,
      headers
    );
  ...
  public async uploadStream<T>(
    ...
    let res: httpm.HttpClientResponse = await this.client.sendStream(
      verb,
      url,
      stream,
      headers
